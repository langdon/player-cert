Vagrant.configure(2) do |config|
  ...
  config.vm.define :vagrant_player do |vagrant_host|
    ...
    #vagrant_host.vm.provision "shell", inline: "sudo usermod -u 1000 vagrant"
    #vagrant_host.vm.provision "shell", inline: "sudo groupmod -g 1000 vagrant"
    ...
    vagrant_host.vm.provision "shell", inline: "cd /home/vagrant/player-cert/src/player-cert && npm install"
    end
end
